...
public class NamespaceParseMain {
	...
	public static void main(String[] args) {
		...
		new NamespaceParseMain().testParseNoHeaderFile(importWithoutColumnName);
		//测试包含header的文件解析
		System.out.println("================测试包含header的CSV文件解析==============");
		new NamespaceParseMain().testParseCSV(baseImport);
		System.out.println("================测试包含header的XLSX文件解析==============");
		new NamespaceParseMain().testParseXLSX(baseImport);
		System.out.println("================测试包含header的XLS文件解析==============");
		new NamespaceParseMain().testParseXLS(baseImport);
		System.out.println("================测试包含各个类型字段的XLSX文件解析==============");
		new NamespaceParseMain().testAdvancedParser(advancedImport);
		//测试列名表示成字符位置的文件
		System.out.println("================测试列名表示成字符位置的TXT文件解析==============");
		new NamespaceParseMain().testParseTXT(importTextFile);
	}
