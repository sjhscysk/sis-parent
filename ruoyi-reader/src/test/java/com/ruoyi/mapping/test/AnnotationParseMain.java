...
import com.ruoyi.mapping.test.config.BaseImport;
import com.ruoyi.mapping.test.config.ImportTextFile;
import com.ruoyi.mapping.test.config.ImportWithoutColumnName;
...
public class AnnotationParseMain {
	...
	public static void main(String[] args) {
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext("com.ruoyi.mapping.test");
		ReaderMappingParser importWithoutColumnName= (ReaderMappingParser)context.getBean("importWithoutColumnName");
		ReaderMappingParser baseImport= (ReaderMappingParser)context.getBean("baseImport");
		ReaderMappingParser advancedImport= (ReaderMappingParser)context.getBean("advancedImport");
		ReaderMappingParser importTextFile= (ReaderMappingParser)context.getBean("importTextFile");
		//测试没有header的文件解析
