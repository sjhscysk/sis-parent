package com.ruoyi.mapping.test.config;

import com.ruoyi.mapping.spring.annotation.DocMappingField;
import com.ruoyi.mapping.spring.annotation.DocMappingParser;
...
public class AdvancedImport {
    @DocMappingField(columnName = "UpperCase Column",required = true,formatStr = "20",converter = "com.ruoyi.mapping.test.parsers.ToUpperCaseParser")
    private String upperCaseField;
    @DocMappingField(columnName = "StringParserThrowE Column",formatStr = "30",converter = "com.ruoyi.mapping.test.parsers.ToStringParserThrowE")
    private String stringParserThrowEField;
    @DocMappingField(columnName = "Date Column",required = true,formatStr = "MM/dd/yyyy;yyyyMMdd",converter = "com.ruoyi.mapping.test.parsers.AdvancedDateParser")
    private Date advancedDateField;
    @DocMappingField(columnName = "Long Column",required = true,formatStr = "12",converter = "com.ruoyi.mapping.test.parsers.ToLongParserThrowE")
    private Long longField;
    @DocMappingField(columnName = "BigDecimal Column",required = true,formatStr = "^-?\\d{1,3}(\\.\\d{0,5})?$",converter = "com.ruoyi.mapping.test.parsers.ToBigDecimalParserThrowE")
