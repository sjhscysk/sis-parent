package com.ruoyi.mapping.spring.annotation;

import com.ruoyi.mapping.DefaultReaderMappingBuilder;
import com.ruoyi.mapping.DefaultReaderMappingParser;
...
public class DocMappingRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    private void registerParser(AnnotationMetadata importingClassMetadata,Class docMappingClass,BeanDefinitionRegistry registry){
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(DefaultReaderMappingParser.class);
        if(attributes == null){
            return;
        }
    ...
    private void registerBuilder(AnnotationMetadata importingClassMetadata,Class docMappingClass,BeanDefinitionRegistry registry){
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(DefaultReaderMappingBuilder.class);
        if(attributes == null){
            return;
        }
        if(!StringUtils.hasText(attributes.getString("id"))){
