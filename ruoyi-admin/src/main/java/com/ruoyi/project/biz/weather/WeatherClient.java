package com.ruoyi.project.biz.weather;
...
import com.ruoyi.project.biz.weather.stub.WeatherWebServiceStub;
...
public class WeatherClient {
     ...
     * @return 字符串 用#分割
     */
    public static List<String> getWeatherbyCityName(String city) {
        try {
            ...
            return Arrays.asList(string.getString());
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> list = getWeatherbyCityName("广州");
